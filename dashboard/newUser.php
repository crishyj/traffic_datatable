    ...
    if (isset($_POST['receiver_id'])) {          
        if ( !empty( $_POST['csrf_token'] ) ) {
            if( checkToken( $_POST['csrf_token'], 'protectedForm' ) ) {
              ...
              $sql1 = $sql = "UPDATE user SET role='$permission' WHERE id='$receiver_id'";
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">New User</div>
            </a>         
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4 registerd_card">
                        <div class="card-header py-3">
                            <h3 class="m-0 font-weight-bold text-primary">Welcome</h3>
                        </div>
                        <div class="card-body">
                            <div class="text-center">
                                <h4> Welcome Visit the Website.</h4>
                                <p>Please get the permission from Manager</p>
