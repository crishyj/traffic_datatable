                ...
                if ($result->num_rows > 0) {
                    ...
                    switch ($role) {
                        case "1":
                            ...
                            break;
                        case "2":
                                $location = 'dashboard/newUser.php';
                                echo"
                                <script>
                                    window.location = 'dashboard/newUser.php';
                                </script>
                                ";
                            break;
                        case "3":
                                $location = 'dashboard/client.php';
                                echo"
                                <script>
                                    window.location = 'dashboard/client.php';
                                </script>
                                ";
                            break;
                        case "4":
                                $location = 'dashboard/dataEntry.php';
                                echo"
                                    <script>
                                        window.location = 'dashboard/dataEntry.php';
                                    </script>
                                ";
                            break;
                        case "5":
                                $location = 'dashboard/manager.php';
                                echo"
                                <script>
                                    window.location = 'dashboard/manager.php';
                                </script>
                                ";
                            break;
                        default:
